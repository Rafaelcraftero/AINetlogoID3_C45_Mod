...
__includes ["ID3_C45_tablas.nls" "DF.nls"]
...
to main-ID3 [att-target]
  ...
  [
    ...
    ID3:tableList
    let Var-name "arbol1"
    let table-layout ID3:ID3 att-target DataFrame Var-name
  ]
end
...
to main-C4.5 [att-target Num-att]
  ...
  [
    ...
    ID3:tableList
    let Var-name "arbol1"
    let table-layout ID3:C4.5 att-target Num-att DataFrame Var-name
    test
...
[\"Outlook\" \"Temp\" \"Humidity\" \"Wind\" \"PlayGolf\"]
1
0
String
